function showTime() { 
	...
	var startDate = new Date(2019,2,30);
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "Dear ZMQ:<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----wbg   2019-04-05 &nbsp</c>"; 
